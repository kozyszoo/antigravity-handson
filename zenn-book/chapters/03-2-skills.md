---
title: "Step 3-2: Agent Skills の作成"
---
...
> 公式ドキュメント: https://github.com/openai/antigravity
...
| **グローバル** | `~/.antigravity/skills/<name>/` | すべてのプロジェクト |
...
<!--
  [図9b: Skills のフォルダ構造]
  【スクリーンショット指示】
  Antigravity CLI のファイルツリー（サイドバー）で、
...
Antigravity CLI のチャットで以下のように入力してください。
