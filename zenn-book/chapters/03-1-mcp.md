---
title: "Step 3-1: MCP（Model Context Protocol）接続"
---
...
Codex CLI の Agent パネルで以下の操作を行ってください。
1. 右上の `...`（三点メニュー）をクリック
2. **MCP Store** を選択

![MCP Settings](../../docs/img/fig8.png)
...
<!--
  ...
  【スクリーンショット指示】
  Codex CLI の MCP Store 画面のキャプチャ。
...
<!--
  ...
  左側（チャット）:
    - ユーザーの入力: 「Browser MCPを使って、『Codex IDE 2026』を検索して...」
...
**次へ進む → [Step 3-2: Agent Skills の作成](./03-2-skills.md)**
