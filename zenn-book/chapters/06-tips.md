...
Antigravity CLI をさらに使いこなすための参考記事・公式リソースをまとめました。ハンズオン後の自習や、チームへの共有にご活用ください。
...
| **モードは基本「Planning」一択** | Planning Mode ではAIがまず計画を立て、宣言してから作業する。Fast Mode は計画なしで即作業するためミスりやすい。複雑なタスクは急がば回れで Planning を選ぶほうが精度が上がる。モデルは `Gemini 3.5 Flash` が安定。 | [note.com/kino_11](https://note.com/kino_11/n/n4a7712b47868) |
...
| カテゴリ | 概要 | URL |
|:---|:---|:---|
| **公式サイト** | Antigravity CLI のダウンロード・プラン・最新情報 | [openai.com](https://openai.com) |
| **公式ドキュメント** | セットアップ・Rules・MCP・Skills・Workflows の詳細リファレンス | [platform.openai.com/docs](https://platform.openai.com/docs) |
| **Rules & Workflows** | GEMINI.md の書き方・Activation Mode・Workflows の設定方法 | [github.com/openai/antigravity](https://github.com/openai/antigravity) |
| **MCP（Model Context Protocol）** | 外部ツール連携（ブラウザ・DB・GitHub 等）の接続手順 | [modelcontextprotocol.io](https://modelcontextprotocol.io) |
| **Agent Skills** | スキルの作成・配置・呼び出し方法のリファレンス | [github.com/openai/antigravity](https://github.com/openai/antigravity) |

### コミュニティ記事

実践的な活用方法や Tips を紹介している記事をまとめました。

- [note.com/kino_11 - Antigravity CLI 基本操作ガイド](https://note.com/kino_11/n/n4a7712b47868)
- [zenn.dev/minedia - Antigravity CLI 実践活用法](https://zenn.dev/minedia/articles/cc718542d8cc73)
- [DevelopersIO - Antigravity 5つのTips](https://dev.classmethod.jp/articles/google-antigravity-five-tips/)
...
このチャプターでは、Antigravity CLI をより効果的に活用するための実践的な Tips と公式リソースを紹介しました。
